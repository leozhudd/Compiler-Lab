...
r10:                                              ; preds = %r9
  %r13 = load i32, i32* %r8, align 4
  %r14 = srem i32 %r13, 3
  %r15 = icmp eq i32 %r14, 1
  br i1 %r15, label %r16, label %r17

r16:                                              ; preds = %r10
  %r19 = load i32, i32* %r1, align 4
  %r20 = add i32 %r19, 1
  call void @putch(i32 %r20)
  br label %r18

r17:                                              ; preds = %r10
  %r21 = load i32, i32* %r1, align 4
  call void @putch(i32 %r21)
  br label %r18

r18:                                              ; preds = %r17, %r16
  %r22 = load i32, i32* %r8, align 4
  %r23 = add i32 %r22, 1
  store i32 %r23, i32* %r8, align 4
  %r24 = load i32, i32* %r8, align 4
  %r25 = load i32, i32* %r2, align 4
  %r26 = mul i32 2, %r25
  %r27 = sub i32 %r26, 1
...
r11:                                              ; preds = %r29, %r9
  ...
  %r32 = load i32, i32* %r2, align 4
  %r33 = add i32 %r32, 1
  store i32 %r33, i32* %r2, align 4
  br label %r3
